...
This directory pins and maps the historical Python source used to validate the
InvisibleDragon and SimpleDragon ports. Exact repository URLs, module keys,
paths, and symbols from that source remain unchanged so hashes and compatibility
