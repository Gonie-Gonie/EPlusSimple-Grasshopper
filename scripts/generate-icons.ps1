...
$products = @(
    ...
    [pscustomobject]@{
        ...
        Components = @(
            ...
            (New-ComponentIcon 'CreateSimpleDragonWindowComponent' 5 'window'),
            (New-ComponentIcon 'CreateSimpleDragonDoorComponent' 5 'door'),
            (New-ComponentIcon 'CreateSimpleDragonGlassDoorComponent' 5 'glazing'),
            ...
            (New-ComponentIcon 'GreenRetrofitModelSummaryComponent' 8 'none'),
        ...
        Parameters = @(
            ...
            (New-ComponentIcon 'SimpleDragonFenestrationParam' 5 'window'),
            ...
            (New-ComponentIcon 'SimpleDragonSurfaceDefinitionParam' 5 'surface'),
