...
using DragonZoneProfile = Dragons.InvisibleDragon.Profile.Profile;
...
public sealed class UsageProfileScheduleParityTests
{
    ...
    public void OracleCoversEveryPinnedProfileInDatabaseOrder()
    {
        ...
        Assert.Equal("dragons.simpledragon.usage-profile-schedule-oracle.v1", oracle.Schema);
    ...
    public void LegacyConversionMatchesPinnedPythonScheduleOracle(int profileIndex)
    {
        ...
        Dragons.InvisibleDragon.Shape.Zone zone = Assert.Single(model.Zones);
