...
public sealed class DatabaseParityOracleTests
{
    ...
    public void SurfaceDatabaseMatchesEveryPinnedPythonEntryAndRegulatedBranch()
    {
        ...
        Assert.Equal("dragons.python-reference.surface-construction-database.v1", sourceOracle.Schema);
        Assert.Equal("dragons.python-reference.database-query-oracle.v1", queryOracle.Schema);
    ...
    public void FenestrationDatabaseMatchesEveryPinnedPythonKeyAndResult()
    {
        ...
        Assert.Equal("dragons.python-reference.fenestration-construction-database.v1", sourceOracle.Schema);
