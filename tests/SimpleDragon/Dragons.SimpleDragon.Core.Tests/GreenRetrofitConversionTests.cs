...
public sealed class GreenRetrofitConversionTests
{
    ...
    public void LegacyConversionUsesLastSameNamedSourceProfileScheduleDefinition()
    {
        ...
        UsageProfile firstProfile = WithLightingHours(
            templateProfile,
            1d,
            new Dragons.BuildingEnergy.Contracts.EntityId("PROFILE-DUPLICATE-FIRST"));
        UsageProfile secondProfile = WithLightingHours(
            templateProfile,
            2d,
            new Dragons.BuildingEnergy.Contracts.EntityId("PROFILE-DUPLICATE-SECOND"));
        ...
        var firstFloor = new Surface(
            ...
            floorConstruction,
            id: new Dragons.BuildingEnergy.Contracts.EntityId("SURFACE-DUPLICATE-A"));
        var secondFloor = new Surface(
            ...
            floorConstruction.Id.Value,
            floorConstruction,
            id: new Dragons.BuildingEnergy.Contracts.EntityId("SURFACE-DUPLICATE-B"));
        var firstZone = new Zone(
            ...
            firstProfile,
            5d,
            id: new Dragons.BuildingEnergy.Contracts.EntityId("ZONE-DUPLICATE-A"));
        var secondZone = new Zone(
            ...
            secondProfile,
            5d,
            id: new Dragons.BuildingEnergy.Contracts.EntityId("ZONE-DUPLICATE-B"));
    ...
    public void CoolRoofUsesPinnedPythonNamesForConstructionLayerAndMaterial()
    {
        ...
        DragonSurface roof = Assert.Single(
            ...
            surface => surface.Id == new Dragons.BuildingEnergy.Contracts.EntityId("SURF-0x000005"));
    ...
    public void StandardProfileDisplayNameMayContainWhitespace()
    {
        ...
        Assert.True(result.Success, Describe(result));
        Dragons.InvisibleDragon.Profile.Profile converted =
    ...
    public void ReciprocalZoneSurfacesNormalizeToExactlyOneMirroredPair()
    {
        ...
        var openingA = new Fenestration(
            ...
            glazing,
            BlindType.Shade,
            new Dragons.BuildingEnergy.Contracts.EntityId("OPEN-A"));
        var openingB = new Fenestration(
            ...
            glazing,
            BlindType.Shade,
            new Dragons.BuildingEnergy.Contracts.EntityId("OPEN-B"));
    ...
    public void OneSidedZoneSurfaceSynthesizesExactlyOneMappedCounterpart()
    {
        ...
        Assert.Equal(new Dragons.BuildingEnergy.Contracts.EntityId("ZONE-A"), synthesized.SourceZoneId);
        Assert.Equal(new Dragons.BuildingEnergy.Contracts.EntityId("ZONE-B"), synthesized.ConvertedZoneId);
    ...
    public void DistinctReciprocalPairsMatchByGeometryInsteadOfInputOrder()
    {
        ...
        Assert.Equal(
            new Dragons.BuildingEnergy.Contracts.EntityId("SURFACE-B12"),
            Assert.Single(converted.Surfaces, item => item.Id.Value == "SURFACE-A12")
                .Boundary.AdjacentSurfaceId);
        Assert.Equal(
            new Dragons.BuildingEnergy.Contracts.EntityId("SURFACE-B18"),
        ...
        IEnumerable<Fenestration>? openings = null)
    {
        return new Surface(
            ...
            id: new Dragons.BuildingEnergy.Contracts.EntityId(id));
    }
        ...
        IEnumerable<Surface> secondSurfaces)
    {
        ...
        var first = new Zone(
            ...
            id: new Dragons.BuildingEnergy.Contracts.EntityId("ZONE-A"));
        var second = new Zone(
            "zone B",
            1,
            templateZone.Height,
            ...
            templateZone.Profile,
            templateZone.LightDensity,
            id: new Dragons.BuildingEnergy.Contracts.EntityId("ZONE-B"));
    ...
    private static UsageProfile WithLightingHours(
        ...
        Dragons.BuildingEnergy.Contracts.EntityId id)
    {
    ...
    private static string Describe(IEnumerable<Dragons.BuildingEnergy.Contracts.Diagnostic> diagnostics)
    {
