...
public sealed class UtilsCoreOracleParityTests
{
    ...
    private const string OracleSchema = "goniegonie.simpledragon.utils-core-oracle.v1";
    private const string EvidenceTestCase =
        "GonieGonie.SimpleDragon.Tests.UtilsCoreOracleParityTests.MatchesPinnedPythonUtilsCore";
