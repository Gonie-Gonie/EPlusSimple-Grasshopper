...
public sealed class UsageProfileCoreOracleParityTests
{
    ...
    private const string OracleSchema =
        "goniegonie.simpledragon.usage-profile-core-oracle.v1";
    private const string EvidenceTestCase =
        "GonieGonie.SimpleDragon.Tests.UsageProfileCoreOracleParityTests.MatchesPinnedPythonUsageProfileCore";
    ...
    private static string ScheduleValuesSha256(DragonSchedule schedule)
    {
        ...
        int count = 0;
        foreach (GonieGonie.InvisibleDragon.Profile.DaySchedule day in schedule.DaySchedules)
        {
