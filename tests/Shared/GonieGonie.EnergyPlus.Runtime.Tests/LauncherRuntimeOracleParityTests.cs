...
public sealed class LauncherRuntimeOracleParityTests
{
    ...
    private const string OracleSchema = "goniegonie.python-reference.launcher-runtime.v1";
    private const string EvidenceTestCase =
        "GonieGonie.EnergyPlus.Runtime.Tests.LauncherRuntimeOracleParityTests.MatchesPinnedPythonLauncherRuntime";
    private const string UpstreamPath = "src/idragon/launcher.py";
    private const string FailureTypeName = "GonieGonie.EnergyPlus.Runtime.EnergyPlusFailure";
    private const string ResolverTargetName =
        "GonieGonie.EnergyPlus.Runtime.RuntimeResolver.ResolveAsync";
    private const string BatchTargetName =
        "GonieGonie.SimpleDragon.Batch.BatchRunner.RunAsync";
    private const string RunnerTargetName =
        "GonieGonie.EnergyPlus.Runtime.EnergyPlusRunner.RunAsync";
    private const string MarkerFileName = ".goniegonie-energyplus-run";
    ...
    private static string[] ExecuteExecutableErrorClassCase()
    {
        ...
        return new[]
        {
            "native_type=GonieGonie.EnergyPlus.Runtime.EnergyPlusFailure",
    ...
    private static void AssertNoHostTokens(string value)
    {
        ...
        Assert.False(Regex.IsMatch(
            ...
            RegexOptions.CultureInvariant));
        Assert.DoesNotContain("goniegonie-launcher-runtime-oracle-", value, StringComparison.OrdinalIgnoreCase);
    }
    ...
    private sealed class ClosedBatchExecutor : IBatchCaseExecutor
    {
        ...
        public string ExecutorIdentity => "GonieGonie.ClosedLauncherRuntimeBatchExecutor/v1";
