...
public sealed class ConstructionFamilyIdfOracleParityTests
{
    ...
    private const string AppendGlazingSymbol =
        "Dragons.InvisibleDragon.Model.EnergyModelIdfAssembler.AppendGlazing";
    private const string EvidenceTestCase =
        "Dragons.InvisibleDragon.Tests.Model.ConstructionFamilyIdfOracleParityTests.MatchesPinnedPythonConstructionFamilyEmissionThroughFreshEnergyModels";
