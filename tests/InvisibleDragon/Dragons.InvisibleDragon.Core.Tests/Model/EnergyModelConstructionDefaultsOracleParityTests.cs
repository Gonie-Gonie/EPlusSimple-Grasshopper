...
public sealed class EnergyModelConstructionDefaultsOracleParityTests
{
    ...
    private const string EvidenceTestCase =
        "Dragons.InvisibleDragon.Tests.Model.EnergyModelConstructionDefaultsOracleParityTests.MatchesPinnedPythonConstructionDefaults";
    ...
    private static void AssertDefaultRawFields(IdfDocument document)
    {
        ...
        AssertFields(limits[0], "ScheduleTypeLimits:Temperature", "-50.0", "200.0", "Continuous", "Temperature");
        AssertFields(limits[1], "ScheduleTypeLimits:Onoff", "0.0", "1.0", "Discrete", "Dimensionless");
        AssertFields(limits[2], "ScheduleTypeLimits:Fraction", "0.0", "1.0", "Continuous", "Dimensionless");
