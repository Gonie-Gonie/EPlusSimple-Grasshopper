...
public sealed class RuleSetOperationsOracleParityTests
{
    private const string OracleSchema =
        "dragons.invisibledragon.rule-set-operations-oracle.v1";
    ...
    private const string EvidenceTestCase =
        "Dragons.InvisibleDragon.Tests.Profile.RuleSetOperationsOracleParityTests.MatchesPinnedPythonOperations";
