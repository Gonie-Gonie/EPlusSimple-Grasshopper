...
public sealed class ConstantsEngineeringOracleParityTests
{
    ...
    private const string EvidenceTestCase =
        "Dragons.InvisibleDragon.Tests.Common.ConstantsEngineeringOracleParityTests.MatchesPinnedPythonConstantsEngineering";
    private const string UpstreamPath = "src/idragon/constants.py";
    private const string UnitTypeName =
        "Dragons.InvisibleDragon.UnitConversions";
    private const string ThermalTypeName =
        "Dragons.InvisibleDragon.ThermalDefaults";
