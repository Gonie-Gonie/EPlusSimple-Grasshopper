...
namespace Dragons.InvisibleDragon.Tests.Results;
...
public sealed class EnergyPlusResultParserOracleParityTests
{
    ...
    private const string EvidenceTestCase =
        "Dragons.InvisibleDragon.Tests.Results.EnergyPlusResultParserOracleParityTests.MatchesPinnedPythonLauncherResultParser";
    private const string UpstreamPath = "src/idragon/launcher.py";
    private const string ParserTypeName =
        "Dragons.InvisibleDragon.Results.EnergyPlusResultParser";
    private const string ResultTypeName =
        "Dragons.InvisibleDragon.Results.EnergyPlusSimulationResult";
