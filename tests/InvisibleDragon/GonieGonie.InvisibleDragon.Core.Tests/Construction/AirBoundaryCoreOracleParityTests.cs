...
public sealed class AirBoundaryCoreOracleParityTests
{
    ...
    private const string InterfacePath =
        "src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Construction/ISurfaceConstruction.cs";
    ...
    private const string DomainGuardPath =
        "src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Internal/DomainGuard.cs";
    ...
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Construction.AirBoundaryCoreOracleParityTests.MatchesPinnedAirBoundaryCoreThroughTypedNativeRoutes";
    ...
    private static readonly TargetBinding[] Targets =
    {
        new(
            ...
            "GonieGonie.InvisibleDragon.Construction.AirBoundary sealed typed record",
    ...
    private static bool DiscoverPins => string.Equals(
        Environment.GetEnvironmentVariable("GONIEGONIE_DISCOVER_AIR_BOUNDARY_CORE_PINS"),
        "1",
    ...
    private static void ValidatePinnedArtifactsAndNativeApi()
    {
        ...
        Assert.Equal("GonieGonie.InvisibleDragon.Construction.AirBoundary", type.FullName);
    ...
    private static void ValidateOracle(JsonElement root)
    {
        ...
        Assert.Equal(
            "goniegonie.python-reference.dragon-construction-air-boundary-core.v1",
        ...
        IReadOnlyList<NativeObservation> observations) => new
    {
        ...
        native_type_fqn = "GonieGonie.InvisibleDragon.Construction.AirBoundary",
