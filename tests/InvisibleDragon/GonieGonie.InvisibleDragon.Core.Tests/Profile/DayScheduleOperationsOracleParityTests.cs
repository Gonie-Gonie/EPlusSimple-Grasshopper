...
public sealed class DayScheduleOperationsOracleParityTests
{
    private const string OracleSchema =
        "goniegonie.invisibledragon.day-schedule-operations-oracle.v1";
    ...
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Profile.DayScheduleOperationsOracleParityTests.MatchesPinnedPythonOperations";
