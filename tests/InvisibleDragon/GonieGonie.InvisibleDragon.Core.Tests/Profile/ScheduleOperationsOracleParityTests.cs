...
public sealed class ScheduleOperationsOracleParityTests
{
    private const string OracleSchema =
        "goniegonie.invisibledragon.schedule-operations-oracle.v1";
    ...
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Profile.ScheduleOperationsOracleParityTests.MatchesPinnedPythonOperations";
