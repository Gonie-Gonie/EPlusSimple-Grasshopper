...
public sealed class ProfileResidualOracleParityTests
{
    ...
    private const string OracleSchema =
        "goniegonie.invisibledragon.profile-residual-oracle.v1";
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Profile.ProfileResidualOracleParityTests.MatchesPinnedPythonProfileResidual";
