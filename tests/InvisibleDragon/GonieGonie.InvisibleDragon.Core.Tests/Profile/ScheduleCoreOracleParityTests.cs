...
public sealed class ScheduleCoreOracleParityTests
{
    ...
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Profile.ScheduleCoreOracleParityTests.MatchesPinnedPythonScheduleCore";
    ...
    private static Dictionary<string, JsonElement> ValidateCorpus(JsonElement root)
    {
        ...
        Assert.Equal(
            "goniegonie.invisibledragon.schedule-core-oracle.v1",
