...
{
    private const string OracleSchema = "goniegonie.energyplus-idd-schema.v1";
    ...
    public sealed class EnergyPlusIddIntegrationFactAttribute : FactAttribute
    {
        public EnergyPlusIddIntegrationFactAttribute()
        {
            ...
            {
                Skip = "Set GONIEGONIE_RUN_ENERGYPLUS_INTEGRATION=1 to compare the installed EnergyPlus 24.2 IDD.";
            }
        }
    }
}
