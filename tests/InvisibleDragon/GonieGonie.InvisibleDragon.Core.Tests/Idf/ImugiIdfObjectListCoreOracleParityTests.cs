...
public sealed class ImugiIdfObjectListCoreOracleParityTests
{
    ...
    private const string Schema = "goniegonie.python-reference.imugi-idf-object-list-core.v1";
    ...
    private const string TestCase = "GonieGonie.InvisibleDragon.Tests.Idf.ImugiIdfObjectListCoreOracleParityTests.MatchesPinnedImugiIdfObjectListThroughPublicProductionApis";
    ...
    {
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Idf/IdfModel.cs", 13_182, "sha256:50aa8a362214d34bba37dcf51ef3c0cce89d54895110a0da786c11d8fe233495"),
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Idf/IdfValidator.cs", 12_094, "sha256:3f1c8c191cf7054ebdbf674895a2efcabe0b4d265c0de093d900efbb369ed3dd"),
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Idf/IdfWriter.cs", 4_289, "sha256:cc7cc49afcd98a4d4067371686feb49d120a4dd5f7bf30611599a6512c062892"),
    };
    ...
    private static string Route(string symbol) => symbol switch
    {
        ...
        _ => "GonieGonie.InvisibleDragon.Idf.IdfObjectCollection/IdfDocument public typed adaptation (no Python API/source compatibility claim)",
    };
