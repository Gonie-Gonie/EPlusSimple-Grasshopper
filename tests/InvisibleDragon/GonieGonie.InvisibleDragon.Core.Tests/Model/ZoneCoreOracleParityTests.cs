...
public sealed class ZoneCoreOracleParityTests
{
    ...
    private const string FixtureSchema =
        "goniegonie.python-reference.dragon-shape-zone-core.v1";
    ...
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Model.ZoneCoreOracleParityTests.MatchesPinnedZoneCoreThroughTypedNativeRoutes";
    ...
    private static readonly ArtifactPin[] NativeArtifacts =
    {
        ...
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Shape/Zone.cs", 6_698,
            "sha256:37bd33ef649a03988255edd9f95bbb0f1ffb7c63cbf8fd1ddb784ebb071b8920"),
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Profile/Profile.cs", 4_079,
    ...
    {
        "Zone" => "GonieGonie.InvisibleDragon.Shape.Zone",
        "Zone.__init__" => "GonieGonie.InvisibleDragon.Shape.Zone constructor(EntityId,string,IEnumerable<Surface>,Profile,double,double,double)",
        "Zone.floor_area" => "GonieGonie.InvisibleDragon.Shape.Zone.FloorArea",
        "Zone.floor_surface" => "GonieGonie.InvisibleDragon.Shape.Zone.FloorSurfaces",
        "Zone.idf_airexhaustnodelistname" => "GonieGonie.InvisibleDragon.Model.EnergyModel.ToIdfDocument -> EnergyModelIdfAssembler.AppendZoneEquipment/AppendNodeList",
        "Zone.idf_airinletnodelistname" => "GonieGonie.InvisibleDragon.Model.EnergyModel.ToIdfDocument -> EnergyModelIdfAssembler.AppendZoneEquipment/AppendNodeList",
        "Zone.idf_equipmentlistname" => "GonieGonie.InvisibleDragon.Model.EnergyModel.ToIdfDocument -> EnergyModelIdfAssembler.AppendZoneEquipment",
        "Zone.supply" => "GonieGonie.InvisibleDragon.Hvac.ZoneHvacAssignment(EntityId,SupplyGroup); no property on Shape.Zone",
    ...
    private static void ValidatePinnedArtifactsAndNativeApi()
    {
        ...
        Assert.Equal("GonieGonie.InvisibleDragon.Shape.Zone", typeof(Zone).FullName);
        ...
        Type assembler = typeof(EnergyModel).Assembly.GetType(
            "GonieGonie.InvisibleDragon.Model.EnergyModelIdfAssembler", throwOnError: true)!;
        ...
        IReadOnlyList<NativeObservation> observations)
    {
        ...
        Assert.Equal("GonieGonie.InvisibleDragon.Shape.Zone", RequiredString(receipt, "native_type_fqn"));
