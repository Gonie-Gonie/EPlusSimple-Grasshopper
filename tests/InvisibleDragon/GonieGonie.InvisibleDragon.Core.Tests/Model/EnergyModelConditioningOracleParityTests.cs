...
public sealed class EnergyModelConditioningOracleParityTests
{
    ...
    private const string OracleSchema =
        "goniegonie.python-reference.dragon-model-conditioning.v1";
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Model.EnergyModelConditioningOracleParityTests.MatchesPinnedPythonConditioning";
