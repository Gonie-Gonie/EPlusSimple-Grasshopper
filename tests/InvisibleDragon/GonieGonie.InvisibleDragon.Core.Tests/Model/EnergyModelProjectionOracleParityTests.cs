...
public sealed class EnergyModelProjectionOracleParityTests
{
    ...
    private const string OracleSchema =
        "goniegonie.python-reference.dragon-model-projections.v1";
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Model.EnergyModelProjectionOracleParityTests.MatchesPinnedPythonProjections";
