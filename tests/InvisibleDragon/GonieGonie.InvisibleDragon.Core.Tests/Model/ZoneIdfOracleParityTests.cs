...
public sealed class ZoneIdfOracleParityTests
{
    ...
    private const string OracleSchema =
        "goniegonie.python-reference.dragon-shape-zone-to-idf-object.v1";
    ...
    private const string AppendGeometrySymbol =
        "GonieGonie.InvisibleDragon.Model.EnergyModelIdfAssembler.AppendConstructionsAndGeometry";
    private const string AppendLoadsSymbol =
        "GonieGonie.InvisibleDragon.Model.EnergyModelIdfAssembler.AppendZoneLoads";
    ...
    private const string AppendSizingSymbol =
        "GonieGonie.InvisibleDragon.Model.EnergyModelIdfAssembler.AppendSizing";
    private const string AppendThermostatSymbol =
        "GonieGonie.InvisibleDragon.Model.EnergyModelIdfAssembler.AppendThermostat";
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Model.ZoneIdfOracleParityTests.MatchesPinnedPythonZoneEmissionThroughFreshEnergyModels";
    ...
    private static void ValidateArtifactsAndNativeBindings()
    {
        ...
        Assert.Equal("GonieGonie.InvisibleDragon.Shape.Zone", zoneType.FullName);
        Assert.Equal(
            new[]
            {
                "FloorArea",
