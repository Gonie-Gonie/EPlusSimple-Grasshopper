...
public sealed class TerrainOracleParityTests
{
    ...
    private const string OracleSchema =
        "goniegonie.python-reference.dragon-model-terrain.v1";
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Model.TerrainOracleParityTests.MatchesPinnedPythonTerrain";
    private const string UpstreamPath = "src/idragon/dragon/model.py";
    private const string NativeTypeName =
        "GonieGonie.InvisibleDragon.Model.Terrain";
