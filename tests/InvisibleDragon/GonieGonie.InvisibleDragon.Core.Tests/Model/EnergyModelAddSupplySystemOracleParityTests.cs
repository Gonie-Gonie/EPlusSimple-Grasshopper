...
public sealed class EnergyModelAddSupplySystemOracleParityTests
{
    ...
    private const string OracleSchema =
        "goniegonie.python-reference.dragon-model-add-supply-system.v1";
    ...
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Model.EnergyModelAddSupplySystemOracleParityTests.MatchesPinnedPythonAddSupplySystemAndNativeModelContextAssembly";
