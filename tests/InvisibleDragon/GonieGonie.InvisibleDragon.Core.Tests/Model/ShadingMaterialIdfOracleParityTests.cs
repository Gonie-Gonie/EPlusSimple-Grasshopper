...
public sealed class ShadingMaterialIdfOracleParityTests
{
    ...
    private const string OracleSchema =
        "goniegonie.python-reference.dragon-shape-shading-material-to-idf-object.v1";
    ...
    private const string AppendWindowShadingSymbol =
        "GonieGonie.InvisibleDragon.Model.EnergyModelIdfAssembler.AppendWindowShading";
    private const string ShadingMaterialSymbol =
        "GonieGonie.InvisibleDragon.Model.EnergyModelIdfAssembler.ShadingMaterial";
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Model.ShadingMaterialIdfOracleParityTests.MatchesPinnedPythonShadingMaterialEmissionInNativeModelContext";
