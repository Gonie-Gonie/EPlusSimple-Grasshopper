...
public sealed class GeometryCoreOracleParityTests
{
    ...
    private const string FixtureSchema =
        "goniegonie.python-reference.dragon-shape-geometry-core.v1";
    ...
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Model.GeometryCoreOracleParityTests.MatchesPinnedGeometryCoreThroughBoundedNativeRoutes";
    ...
    private static readonly ArtifactPin[] NativeArtifacts =
    {
        ...
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Shape/GeometryTolerance.cs", 505,
            "sha256:d71c816f1eac7c0f4d4bb6d3978640e764f25bdb4007f3ceda57b44d7ca0fcc0"),
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Shape/Vertex.cs", 3_795,
            "sha256:f37b229b45b23c23ddc54ed85aea1b93a201a74c30c7b29793f268e364435a67"),
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Shape/Vector3.cs", 3_782,
            "sha256:02536827db9d1c6ff48a46678871e4d736d9536228f0de370a9fb2c5294b9ede"),
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Shape/PlanarPolygon.cs", 16_524,
            "sha256:73a1dd052fb12ed0802a6236d21484e2b680cbe3f0f4005ade6a61995111c653"),
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Shape/Surface.cs", 7_731,
            "sha256:545dc79dd89e84acf6d714e79da7b2cda059dfcaa3b4f74d291ad572ebd51264"),
        new("src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/Shape/SurfaceBoundary.cs", 1_909,
    ...
    {
        "Surface" => "GonieGonie.InvisibleDragon.Shape.Surface constructor; GonieGonie.InvisibleDragon.Shape.PlanarPolygon constructor",
        "Surface.area" => "GonieGonie.InvisibleDragon.Shape.Surface.GrossArea; GonieGonie.InvisibleDragon.Shape.PlanarPolygon.Area",
        "Surface.center" => "GonieGonie.InvisibleDragon.Shape.Surface.Center; GonieGonie.InvisibleDragon.Shape.PlanarPolygon.Centroid",
        "Surface.height" => "GonieGonie.InvisibleDragon.Shape.Surface.Height; GonieGonie.InvisibleDragon.Shape.PlanarPolygon.Height",
        "Surface.normal" => "GonieGonie.InvisibleDragon.Shape.Surface.Normal; GonieGonie.InvisibleDragon.Shape.PlanarPolygon.Normal",
        "Surface.type" => "GonieGonie.InvisibleDragon.Shape.Surface.Type",
        "Surface.vertex" => "GonieGonie.InvisibleDragon.Shape.Surface.Polygon; GonieGonie.InvisibleDragon.Shape.PlanarPolygon.Vertices",
        "SurfaceType" => "GonieGonie.InvisibleDragon.Shape.SurfaceType",
        "SurfaceType.CEILING" => "GonieGonie.InvisibleDragon.Shape.SurfaceType.Ceiling",
        "SurfaceType.FLOOR" => "GonieGonie.InvisibleDragon.Shape.SurfaceType.Floor",
        "SurfaceType.WALL" => "GonieGonie.InvisibleDragon.Shape.SurfaceType.Wall",
        "SurfaceType.__str__" => "no direct lowercase override; System.Enum.ToString is observed",
        "Vertex" => "GonieGonie.InvisibleDragon.Shape.Vertex readonly struct",
        "Vertex.__add__" => "GonieGonie.InvisibleDragon.Shape.Vertex.op_Addition(Vertex,Vector3)",
        "Vertex.__deepcopy__" => "no direct method; GonieGonie.InvisibleDragon.Shape.Vertex value-copy semantics",
        "Vertex.__init__" => "GonieGonie.InvisibleDragon.Shape.Vertex constructor(double,double,double)",
        "Vertex.__iter__" => "no direct iterator; GonieGonie.InvisibleDragon.Shape.Vertex.X/Y/Z explicit projection",
        "Vertex.__mul__" => "GonieGonie.InvisibleDragon.Shape.Vector3.op_Multiply(Vector3,double) after Vertex.ToVector",
        "Vertex.__radd__" => "no direct method; Vertex.Origin + Vertex.ToVector identity adaptation",
        "Vertex.__rmul__" => "GonieGonie.InvisibleDragon.Shape.Vector3.op_Multiply(double,Vector3) after Vertex.ToVector",
        "Vertex.__sub__" => "GonieGonie.InvisibleDragon.Shape.Vertex.op_Subtraction(Vertex,Vertex)",
        "Vertex.__truediv__" => "GonieGonie.InvisibleDragon.Shape.Vector3.op_Division(Vector3,double) after Vertex.ToVector",
        "Vertex.are_coplanar" => "GonieGonie.InvisibleDragon.Shape.Vertex.AreCoplanar(IEnumerable<Vertex>,double)",
        "Vertex.cross" => "GonieGonie.InvisibleDragon.Shape.Vector3.Cross after Vertex.ToVector",
        "Vertex.distance" => "GonieGonie.InvisibleDragon.Shape.Vertex.DistanceTo",
        "Vertex.dot" => "GonieGonie.InvisibleDragon.Shape.Vector3.Dot after Vertex.ToVector",
        "Vertex.norm" => "GonieGonie.InvisibleDragon.Shape.Vector3.Length after Vertex.ToVector",
        "Vertex.unit" => "GonieGonie.InvisibleDragon.Shape.Vector3.Normalize after Vertex.ToVector",
        "Vertex.x" => "GonieGonie.InvisibleDragon.Shape.Vertex.X",
        "Vertex.y" => "GonieGonie.InvisibleDragon.Shape.Vertex.Y",
        "Vertex.z" => "GonieGonie.InvisibleDragon.Shape.Vertex.Z",
