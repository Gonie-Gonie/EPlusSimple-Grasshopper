...
public sealed class CommonCoreOracleParityTests
{
    ...
    private const int OracleByteLength = 34_831;
    private const int ExpectedCaseCount = 39;
    private const string OracleSchema =
        "goniegonie.invisibledragon.common-core-oracle.v1";
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Common.CommonCoreOracleParityTests.MatchesPinnedPythonCommonCore";
