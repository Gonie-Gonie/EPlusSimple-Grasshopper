...
using DragonPackageInfo = GonieGonie.InvisibleDragon.PackageInfo;
...
public sealed class ConstantsMetadataOracleParityTests
{
    ...
    private const string CoreProjectPath =
        "src/InvisibleDragon/GonieGonie.InvisibleDragon.Core/GonieGonie.InvisibleDragon.Core.csproj";
    ...
    private const string EvidenceTestCase =
        "GonieGonie.InvisibleDragon.Tests.Common.ConstantsMetadataOracleParityTests.MatchesPinnedConstantsMetadataThroughBoundedNativeAdaptations";
    ...
    private static readonly TargetBinding[] Targets =
    {
        new(568, "Directory", "class",
            ...
            "GonieGonie.EnergyPlus.Runtime.RuntimeResolver and caller-supplied resource paths",
            new[] { 0, 2, 3 }, new[] { 1 }),
        ...
        new(571, "Directory.PROFILE_DIR", "constant",
            ...
            "typed GonieGonie.InvisibleDragon.Profile values supplied by callers",
            new[] { 0, 1, 2 }, new[] { 3 }),
        new(572, "PackageInfo", "class",
            ...
            "GonieGonie.InvisibleDragon.PackageInfo static class",
            new[] { 4, 5, 6 }, new[] { 7, 8, 9 }),
        new(573, "PackageInfo.NAME", "constant",
            ...
            "GonieGonie.InvisibleDragon.PackageInfo.Name (InvisibleDragon)",
            new[] { 4, 5, 7 }, new[] { 6 }),
        ...
        new(575, "PackageInfo.VERSION", "constant",
            ...
            "GonieGonie.InvisibleDragon.PackageInfo.Version (0.1.0)",
            new[] { 4, 5, 8 }, new[] { 6 }),
    };
    ...
    private static bool DiscoverPins => string.Equals(
        Environment.GetEnvironmentVariable("GONIEGONIE_DISCOVER_CONSTANTS_METADATA_PINS"),
        "1",
    ...
    private static void ValidateOracle(JsonElement root)
    {
        ...
        Assert.Equal("goniegonie.python-reference.constants-metadata.v1", RequiredString(root, "schema"));
    ...
    {
        "Directory" => "GonieGonie.EnergyPlus.Runtime.RuntimeResolver",
        "Directory.ENERGYPLUS_DIR" => "GonieGonie.EnergyPlus.Runtime.EnergyPlusRuntimeLayout.RootPath",
        "Directory.IDD_DIR" => "GonieGonie.EnergyPlus.Runtime.EnergyPlusRuntimeLayout.IddPath",
        "Directory.PROFILE_DIR" => "GonieGonie.InvisibleDragon.Profile.Profile; no native profile-directory member",
        "PackageInfo" => "GonieGonie.InvisibleDragon.PackageInfo",
        "PackageInfo.NAME" => "GonieGonie.InvisibleDragon.PackageInfo.Name",
        "PackageInfo.REQUIRED_PYTHON" => "no native member; PackageInfo project TargetFrameworks metadata",
        "PackageInfo.VERSION" => "GonieGonie.InvisibleDragon.PackageInfo.Version",
