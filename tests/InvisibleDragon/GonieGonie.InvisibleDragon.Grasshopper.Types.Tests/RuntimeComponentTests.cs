...
public sealed class RuntimeComponentTests
{
    ...
    [Fact]
    public void PrepareRuntimeComponentMakesNetworkIntentExplicitAndReportsProgress()
    {
        Assembly assembly = LoadPlugin();
        ...
        Assert.Contains("weather files are never downloaded", component.Description, StringComparison.OrdinalIgnoreCase);
    ...
    public void RunComponentOnlyBootstrapsAsPartOfAnExplicitRunRequest()
    {
        ...
        Assert.Contains("never weather", component.Params.Input[9].Description, StringComparison.OrdinalIgnoreCase);
