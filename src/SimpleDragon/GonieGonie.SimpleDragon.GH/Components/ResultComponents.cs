...
public sealed class ReadGreenRetrofitResultComponent : SimpleDragonComponent
{
    ...
    protected override void RegisterOutputParams(GH_OutputParamManager pManager)
    {
        ...
        pManager.AddParameter(new SimpleDragonDiagnosticParam(), "Diagnostics", "D", "GRR read diagnostics.", GH_ParamAccess.list);
    }
    ...
    protected override void Solve(IGH_DataAccess DA)
    {
        ...
        DA.SetDataList(3, read.Diagnostics.Select(item => new SimpleDragonDiagnosticGoo(item)));
    }
}
