...
public static class BatchRunner
{
    ...
    private static string ComputeRunFingerprint(PreparedCase[] cases, int maxDegreeOfParallelism)
    {
        ...
        using (var writer = new Utf8JsonWriter(stream))
        {
            ...
            writer.WriteString("schema", "goniegonie.simple-dragon.batch-run.v1");
...
internal static class BatchCache
{
        ...
        out CachedExecution? execution)
    {
        ...
        try
        {
            ...
            if (!string.Equals(
                    ...
                    "goniegonie.simple-dragon.batch-cache.v1",
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            writer.WriteStartObject();
            writer.WriteString("schema", "goniegonie.simple-dragon.batch-cache.v1");
...
internal static class BatchOutputWriter
{
        ...
        IReadOnlyList<BatchCaseResult> cases)
    {
        ...
        {
            writer.WriteStartObject();
            writer.WriteString("schema", "goniegonie.simple-dragon.batch-manifest.v1");
            ...
            writer.WriteString("invisible_dragon_core_version", GonieGonie.InvisibleDragon.PackageInfo.Version);
