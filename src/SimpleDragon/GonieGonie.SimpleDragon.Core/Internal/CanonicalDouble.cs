...
internal static class CanonicalDouble
{
    ...
    internal static string Format(double value) => Format(value, pythonLayout: false);
    ...
    private static string Format(double value, bool pythonLayout)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(value), "A canonical JSON number must be finite.");
        }
