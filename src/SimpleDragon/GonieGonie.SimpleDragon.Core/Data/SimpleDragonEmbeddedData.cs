...
public static class SimpleDragonEmbeddedData
{
    ...
    private static readonly ReadOnlyDictionary<string, string> ResourceNames =
        new ReadOnlyDictionary<string, string>(
            ...
            {
                [Material] = "GonieGonie.SimpleDragon.Data.construction.material.csv",
                [SurfaceRegulations] = "GonieGonie.SimpleDragon.Data.construction.construction_regulation_surface.csv",
                [FenestrationRegulations] = "GonieGonie.SimpleDragon.Data.construction.construction_regulation_fenestration.csv",
                [KoreanHoliday] = "GonieGonie.SimpleDragon.Data.profile.KoreanHoliday.csv",
                [KoreanUsageProfile] = "GonieGonie.SimpleDragon.Data.profile.KoreanUsageProfile.csv",
                [KoreanUsageProfileExtended] = "GonieGonie.SimpleDragon.Data.profile.KoreanUsageProfileExtended.csv",
                [ClimateRegions] = "GonieGonie.SimpleDragon.Data.weather.climate-regions.csv",
                [AddressWeather] = "GonieGonie.SimpleDragon.Data.weather.address-weather.csv",
            });
