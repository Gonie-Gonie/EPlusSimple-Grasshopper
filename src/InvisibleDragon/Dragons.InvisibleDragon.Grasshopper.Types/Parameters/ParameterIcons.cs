...
namespace Dragons.InvisibleDragon.Grasshopper.Parameters;
...
internal static class ParameterIcons
{
    ...
    {
        ResourcePrefix + nameof(DragonLayerParam) + ".png",
        ResourcePrefix + nameof(DragonGlazingParam) + ".png",
        ResourcePrefix + nameof(DragonOpeningParam) + ".png",
        ResourcePrefix + nameof(DragonZoneDefinitionParam) + ".png",
    };
        ...
        if (stream is null)
        {
            if (!FallbackResourceNames.Contains(resourceName))
            {
                throw new InvalidOperationException(
                    "Missing embedded InvisibleDragon parameter icon '" + resourceName + "'.");
            }
