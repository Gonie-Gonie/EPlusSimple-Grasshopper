...
public sealed class ClosedSingleSpeedCoolingTower : CoolingTower
{
        ...
        SourceSystem source)
    {
        ...
        return context.Create(
            ...
            IdfGenerationContext.Field(4, "Design Air Flow Rate U-factor Times Area Value", null),
...
public sealed class ClosedTwoSpeedCoolingTower : CoolingTower
{
        ...
        SourceSystem source)
    {
        ...
        return context.Create(
            ...
            IdfGenerationContext.Field(2, "Water Outlet Node Name", $"{name} Water OutletNode"),
            IdfGenerationContext.Field(3, "Performance Input Method", "NominalCapacity"),
            IdfGenerationContext.Field(4, "High Fan Speed U-factor Times Area Value", null),
            IdfGenerationContext.Field(5, "Low Fan Speed U-factor Times Area Value", null),
            IdfGenerationContext.Field(7, "High Speed Nominal Capacity", CapacityFor(source)),
            IdfGenerationContext.Field(8, "Low Speed Nominal Capacity", "autocalculate"),
