...
public sealed record EnergyPlusRuntimeManifest(
    ...
    string CreatedBy)
{
    public const string SupportedSchema = "dragons.energyplus-runtime.v3";
    public const string UserSuppliedWeatherPolicy = "user-supplied";

    private const string LegacySchemaV1 = "dragons.energyplus-runtime.v1";
    private const string LegacySchemaV2 = "dragons.energyplus-runtime.v2";
