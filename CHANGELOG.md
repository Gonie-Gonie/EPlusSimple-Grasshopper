...
- Separate the complex two-zone composition/IDF authoring example from the
  stable electric-radiator example used for the full managed EnergyPlus,
  result, GRR, and CSV gate.
