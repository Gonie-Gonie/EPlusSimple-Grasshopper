...
EVIDENCE_SCHEMA = "goniegonie.upstream-symbol-evidence.v1"
EVIDENCE_RESULTS_SCHEMA = "goniegonie.upstream-evidence-results.v1"
SCOPE_DECISIONS_SCHEMA = "goniegonie.upstream-scope-decisions.v1"
