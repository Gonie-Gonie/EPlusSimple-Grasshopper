"""Command-line entry point for the Dragons upstream tracker."""
...
def _create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="dragons-upstream-tracker",
        description="Classify historical source drift and map impacted Dragons tests.",
    )
    parser.add_argument(
        "--repository-root",
        type=Path,
...
def _validate(
    ...
    data = {
        ...
        "schema": "dragons.upstream-validation.v1",
        ...
        json.dumps(
            {
                ...
                "schema": "dragons.upstream-inventory-rebase.v1",
        ...
        json.dumps(
            {
                ...
                "schema": "dragons.reviewed-safe-scope-integration.v1",
