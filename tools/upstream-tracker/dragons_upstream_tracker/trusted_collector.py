...
named by ``DRAGONS_EVIDENCE_RECORDS_DIRECTORY``.  A record has this exact
shape (``output`` may be any finite JSON value)::

    {
      ...
      "output": {"value": 1},
      "schema": "dragons.trusted-evidence-record.v1",
      "session_nonce": "...",
...
REQUEST_SCHEMA = "dragons.trusted-evidence-request.v1"
CHILD_RESULT_SCHEMA = "dragons.trusted-evidence-child-result.v1"
RECORD_SCHEMA = "dragons.trusted-evidence-record.v1"
AUTHORITY_RECEIPT_SCHEMA = "dragons.trusted-evidence-authority-receipt.v1"
ARTIFACT_INDEX_SCHEMA = "dragons.trusted-evidence-artifact-index.v1"
SDK_MANIFEST_SCHEMA = "dragons.trusted-dotnet-sdk-manifest.v1"
EVALUATED_GRAPH_SCHEMA = "dragons.trusted-msbuild-evaluated-graph.v1"
_INVENTORY_SCHEMA = "dragons.upstream-public-symbol-inventory.v2"
_EVIDENCE_SCHEMA = "dragons.upstream-symbol-evidence.v1"
_MATRIX_SCHEMA = "dragons.upstream-compatibility-matrix.v1"
...
_COLLECTOR_PATH = "tools/upstream-tracker/dragons_upstream_tracker/trusted_collector.py"
    ...
    environment.update(
        {
            ...
            "DRAGONS_EVIDENCE_RECORDS_DIRECTORY": str(records_root),
            "DRAGONS_EVIDENCE_SESSION_NONCE": request["nonce"],
