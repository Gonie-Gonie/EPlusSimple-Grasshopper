...
SCHEMA = "goniegonie.python-reference.epsimple-hvac-supply-system.v1"
...
def _load_base() -> Any:
    ...
    spec = importlib.util.spec_from_file_location(
        "_goniegonie_epsimple_hvac_supply_system_base", BASE_PATH
    )
...
def _native_route(symbol: str) -> str:
    ...
    if symbol in {"SupplySystem", "SupplySystem.coolable", "SupplySystem.heatable"}:
        return "GonieGonie.SimpleDragon.SupplySystem constructor and public properties"
    return (
        "GonieGonie.SimpleDragon.SupplySystem constructor with "
