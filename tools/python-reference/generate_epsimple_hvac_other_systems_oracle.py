...
SCHEMA = "goniegonie.python-reference.epsimple-hvac-other-systems.v1"
...
def _load_base() -> Any:
    ...
    spec = importlib.util.spec_from_file_location(
        "_goniegonie_epsimple_hvac_other_systems_base", BASE_PATH
    )
...
def _native_route(symbol: str) -> str:
    ...
    if symbol in _PROPERTY_ROUTES:
        return "GonieGonie.SimpleDragon." + _PROPERTY_ROUTES[symbol]
    if member == "from_json":
        collection = (
    ...
    return (
        f"GonieGonie.SimpleDragon.{native_type} constructor, public immutable "
...
NATIVE_SOURCE_RECEIPTS = (
    {
        "bytes": 3_855,
        "path": "src/SimpleDragon/GonieGonie.SimpleDragon.Core/Hvac/OtherSystems.cs",
