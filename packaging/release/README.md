...
packages/
|-- rhino7/
|   |-- invisible-dragon-0.1.2-rh7-win.yak
|   `-- simple-dragon-0.1.2-rh7-win.yak
`-- rhino8/
    |-- invisible-dragon-0.1.2-rh8-win.yak
    `-- simple-dragon-0.1.2-rh8-win.yak
```

`release-manifest.json` uses schema
`dragons-grasshopper.windows-installer.v1`, version `0.1.2`, and an
